...
describe('UsersController (e2e)', () => {
  ...
  it('GET: [HOST]/blogger/users/blog/:blogId: should return code 200 and array with 1 elements with searchLoginTerm=ser4', async () => {
    const users = await request(app.getHttpServer())
      .get(`/blogger/users/blog/${blog1Id}?searchLoginTerm=ser4`)
      .auth(accessTokenUser1, { type: 'bearer' })
      .expect(200);
